...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/26 00:00:33 by kmazier           #+#    #+#             */
/*   Updated: 2020/12/26 00:00:33 by kmazier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_draw_pixel_if_not_black(t_vars *vars,
...
void				ft_draw_ver_line(t_vars *vars, int x,
...
void				ft_draw_texture_line(t_vars *vars, t_img img,
int x, int k[4]);
